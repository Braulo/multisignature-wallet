...
const Sidenav = () => {
  ...
  return (
    <aside className="fixed justify-center items-center dark:bg-black bg-white dark:text-white text-black h-1/4 w-1/5 rounded-br-lg bg-opacity-80 dark:bg-opacity-80">
